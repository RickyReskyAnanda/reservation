	      	...
	      	<form method="post" action="{{url('sandwich/master-data/tipe-venue/tambah')}}">
		      	...
		      	<div class="modal-body">
		      		<div class="form-group">
		      			...
		      			<input class="form-control" name="nama" placeholder="Masukkan Nama Tipe Venue.." type="text" value="{{old('nama')}}" required>
		      		</div>
		      		<div class="form-group">
		      			<label>Tag</label>
		      			<input class="form-control" name="tag" placeholder="Masukkan Tag.." type="text" value="{{old('tag')}}">
		      		</div>
		      	</div>
