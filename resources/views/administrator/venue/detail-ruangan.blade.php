							...
							<div class="table-responsive">
								...
								<table class="table project-table" id="dataTable">
									...
									<tbody>
										...
										<tr>
					                      <td><div class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapusPaket" onclick="setHapusPaket('{{base64_encode(base64_encode(strval($paket->id_package)))}}')"><i class="fa fa-trash"></i></div></td>
					                      <td>{{$paket->name}}</td>
					                      <td>{{number_format($paket->price).',-'.$paket->price_satuan}}</td>
					                      <td>{{$paket->durasi_waktu.' '.$paket->durasi_satuan}}</td>
					                      <td>{{$paket->start}} - {{$paket->end}}</td>
					                      <td><?=$paket->informasi;?></td>
					                    </tr>
										@endforeach
									</tbody>
								</table>
          ...
          <div class="modal-body">
            <div class="form-group">
              ...
              <select class="form-control" name="paket">
                ...
                @foreach($ruangan->getPackage as $pakets)
