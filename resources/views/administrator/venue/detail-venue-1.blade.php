                ...
                <form action="{{url('sandwich/venue/pengaturan')}}" method="post">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      ...
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" name="is_meja" <?php if($detail->is_table == '1')echo "checked";?>>
                          Meja
                        </label>
                      </div>
                      <div class="checkbox">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-2 control-label text-right">Informasi</label>
                    <div class="col-sm-10">
                      <textarea class="form-control" name="information" required>{{$detail->information}}</textarea>
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-2 control-label text-right">Tampil</label>
                    <div class="col-sm-10">
                        <select class="form-control" name="sts" required>
                          <option value="0" <?php if($detail->sts == '0')echo "selected";?>>Disembunyikan</option>
                          <option value="1" <?php if($detail->sts == '1')echo "selected";?>>Ditampilkan</option>
                        </select>
                    </div>
                  </div>
