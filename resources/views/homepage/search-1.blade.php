  ...
  <body id="page-top">
    ...
    <script type="text/javascript">
                  ...
                  '<div class="card-body p-2 border-top border-right border-left">'+
                    '<div class="row">'+
                      ...
                      '<div class="col-md-9 pl-0">'+
                        ...
                        '<h5 class="card-title text-primary fw-7"><a href="'+itemData.url_venue+'">'+itemData.venue_name+'</a></h5>'+
      ...
      $(document).on('click','.card-btn-call',function(){
        ...
        if(itemData[itemIndex].contact_number == null){
          itemData[itemIndex].contact_number = ' ';
        }
        if(itemData[itemIndex].official_number == null){
          itemData[itemIndex].official_number = ' ';
        }
