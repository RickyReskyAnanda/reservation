<?php
Route::domain('ceklokasi.id')->group(function () {
...
Route::domain('sandwich.ceklokasi.id')->group(function () {
    ...
    Route::group(['middleware' => ['access-log','admin']], function () {
...
Route::prefix('mobile-app')->group(function () {
	Route::namespace('Mobile_App')->group(function () {
		Route::get('/{id?}', 'BasicController@index')->where('id', '[0-9]+');
